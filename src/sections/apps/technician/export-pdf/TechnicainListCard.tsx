...
export default function TechnicainListCard({ technician }: Props) {
  const theme = useTheme();

  return (
    <Document title={`${technician?.firstName} ${technician.lastName}`}>
        ...
        <View style={styles.container}>
          <View style={styles.row}>
            ...
            <View style={styles.CardInfo}>
              <Text style={styles.title}>{`${technician?.firstName} ${technician.lastName}`}</Text>
          ...
          <View style={[styles.row, { alignItems: 'flex-start' }]}>
            <View style={styles.leftColumn}>
              <View style={styles.card}>
                ...
                {/* <Text style={[styles.about, styles.cardContent]}>Hello, {technician.about}</Text> */}
              </View>
              <View style={styles.card}>
            ...
            <View style={styles.rightColumn}>
              <View style={[styles.card, styles.infoCard]}>
                ...
                <View style={styles.userDetails}>
                  ...
                  <Text style={styles.iconTitle}>{technician.location}</Text>
                </View>
                <View style={styles.userDetails}>
