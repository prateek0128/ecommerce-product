...
import ListCard from './export-pdf/CustomerListCard';
...
export default function CustomerPreview({ customer, open, onClose, editCustomer }: Props) {
  ...
  return (
    <>
          ...
          <DialogTitle sx={{ px: 0 }}>
            <List sx={{ width: 1, p: 0 }}>
              <ListItem
                ...
                secondaryAction={
                  <Stack direction="row" alignItems="center" justifyContent="center" spacing={0}>
                    <PDFDownloadLink document={<ListCard customer={customer} />} fileName={`Customer-${newCustomerName}.pdf`}>
              ...
              >
                ...
                <ListItemText
                  primary={<Typography variant="h5">{newCustomerName}</Typography>}
                  secondary={<Typography color="secondary">{customer.techRole}</Typography>}
                />
              </ListItem>
            </List>
          </DialogTitle>
                  ...
                  <Grid container spacing={2.25}>
                    <Grid item xs={12}>
                      <MainCard title="About me">
                        <Typography>
                          Hello, Myself {newCustomerName}, I’m {customer.techRole} in international company.
                        </Typography>
                      </MainCard>
                    </Grid>
                    <Grid item xs={12}>
      ...
      <AlertCustomerDelete id={customer.id!} title={newCustomerName} open={openAlert} handleClose={handleClose} />
    </>
  );
}
