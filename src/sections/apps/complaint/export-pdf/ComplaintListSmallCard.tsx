...
export default function ComplaintListSmallCard({ customer }: Props) {
  const theme = useTheme();
  const newCustomerName = customer.firstName + ' ' + customer.lastName;
  return (
    <Document title={`${newCustomerName}`}>
        ...
        <View style={styles.container}>
          <View style={styles.row}>
            ...
            <View style={styles.CardInfo}>
              <Text style={styles.title}>{newCustomerName}</Text>
              <Text style={styles.role}>{customer.techRole}</Text>
            </View>
          </View>
          <View style={styles.hr} />
          <View>{/* <Text style={styles.about}>Hello, {customer.about}</Text> */}</View>
          ...
          <View style={styles.timer}>{/* <Text style={styles.iconTitle}> Updated in {customer.time}</Text> */}</View>
        </View>
      </Page>
    </Document>
  );
